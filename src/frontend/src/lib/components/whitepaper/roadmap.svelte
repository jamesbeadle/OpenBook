...
<div class="flex flex-col space-y-4 mt-4">
  ...
  <ul class="list-disc px-4">
    <li>
      Maintaining the delicate balance between data security and transparency.
    </li>
    <li>
      Ensuring private data remains protected while providing necessary insights
      to stakeholders.
    </li>
  </ul>
  ...
  <p>2024: Launch of OpenBook MVP</p>
  ...
  <ul class="list-disc px-4">
    ...
    <li>
      Seamless integration of these core services to establish the primary data
      lake.
    </li>
  </ul>
  ...
  <ul class="list-disc px-4">
    <li>
      Adding Joint Venture Accounting, Timesheet Management, Project Management,
  ...
  <p>2025: Enriching the Platform</p>
  ...
  <ul class="list-disc px-4">
    ...
    <li>
      AI tools aimed at improving financial forecasting, operational efficiency,
  ...
  <ul class="list-disc px-4">
    ...
    <li>
      Introduction of a comprehensive business profile platform, aiming to rival
      established networks like LinkedIn.
    </li>
    <li>
      Seamless integration of recruitment, career achievements, and professional
      networking into OpenBook.
    </li>
    <li>
